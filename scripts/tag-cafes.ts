 ...
 *
 * Cafes already tagged with tag_source = 'human' are never overwritten by
 * this script — see the humanTaggedIds check in main().
 *
...
import { extractJson, validateTags, type InferredTags } from "./lib/ai-tagging";
